(ns instrumentmaker.actor
  "InstrumentMakerActor — the ISCO-08 7312 musical-instrument-making/
  tuning workshop scheduling/logistics coordination actor as a
  ...
  resume after human sign-off. Modeled on cloud-itonami-isco-7222's
  toolmaker.actor for the physical-safety-domain shape.
  ...
  The unconditional invariant: the Instrument Maker Advisor can never
  directly commit an operating record the InstrumentMakerGovernor
  ...
  execution of a specific instrument) or override a workshop safety
  ...
  SCHEDULING/LOGISTICS ONLY — it never builds or tunes an instrument
  itself or authorizes instrument-making/tuning work itself."
...
(defn build-graph
  "Build a compiled InstrumentMakerActor graph. `store` implements
  `instrumentmaker.store/Store`. `advisor` implements
  `instrumentmaker.advisor/Advisor` (defaults to `mock-advisor`).
